...
public class TestConstructor {
  ...
  public void testGoodValues() {
    ...
    new EnableTransaction(0, "John Doe", 0, "", context);
  }
  ...
  public void testUserIsNotAdmin() {
    try {
      ...
      EnableTransaction transaction = new EnableTransaction(1, "John Doe", 0, "", context);
  ...
  public void testNoAccountHolderName() {
    try {
      TransactionContext context = new TransactionContext(0);
      context.currentUserIsAdministrator = true;
      EnableTransaction transaction = new EnableTransaction(1, "", 0, "", context);
  ...
  public void testNonEmptyMisc() {
    ...
    try {
      new EnableTransaction(1, "John Doe", 0, "A", context);
      fail(
  ...
  public void testNonZeroAmount() {
    ...
    try {
      new EnableTransaction(1, "John Doe", 50, "", context);
      fail(
