...
public class TestConstructor {
  ...
  public void testGoodValues() {
    ...
    new ChangePlanTransaction(0, "John Doe", 0, "", context);
  }
  ...
  public void testUserIsNotAdmin() {
    try {
      ...
      ChangePlanTransaction transaction = new ChangePlanTransaction(1, "John Doe", 0, "", context);
  ...
  public void testNoAccountHolderName() {
    try {
      TransactionContext context = new TransactionContext(0);
      context.currentUserIsAdministrator = true;
      ChangePlanTransaction transaction = new ChangePlanTransaction(1, "", 0, "", context);
  ...
  public void testNonEmptyMisc() {
    ...
    try {
      new ChangePlanTransaction(1, "John Doe", 0, "A", context);
      fail(
  ...
  public void testNonZeroAmount() {
    ...
    try {
      new ChangePlanTransaction(1, "John Doe", 50, "", context);
      fail(
